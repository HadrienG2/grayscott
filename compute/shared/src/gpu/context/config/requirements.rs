...
use vulkano::device::DeviceProperties;

/// Device requirements when a particular work-group size is used
pub fn for_work_group(properties: &DeviceProperties, work_group_shape: Shape) -> bool {
...
pub fn for_dispatch(properties: &DeviceProperties, dispatch_size: [u32; 3]) -> bool {
